...
newTrial("intro1",
    ...
    newText("Здраво, истражуваме како родни говорители на македонски би оцениле реченици зависно од нивната сложеност.")
    .css("width","40em")
    .css("line-height","1.4")
    //.css("padding-top","40px")
    .css("padding-bottom","20px")
    ...
    newText("Вашата задача е да ислушате реченица и потоа да ја оцените на скала од 1 до 7 (1 – апсолутно неприфатлива, 7 – апсолутно прифатлива) по тоа колку Вам ви е прифатлива во секојдневниот говор, односно, по вашата интуиција како роден говорител. Секоја реченица ќе ја слушнете само еднаш.")
    .css("width","40em")
    .css("line-height","1.4")
    //.css("padding-top","40px")
    .css("padding-bottom","20px")
...
newTrial( "bye" ,
   exitFullscreen()
   ,
   newText("Го завршивте експериментот. Благодарам што учествувавте! Ако имате некои прашаша за експериментот, слободно обратете се по електронска пошта на 'metodi.efremov@student.ung.si'.")
       .css("width","40em")
       .css("padding-top","10%")
       .css("line-height","1.4")
       .print()
